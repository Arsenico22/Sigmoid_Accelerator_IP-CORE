...
golden_model = load('sigmoid_1024_outputs_sw.txt');

% Carica i valori HEX di Vivado
hex_data = textread('risultati_HW_1024.hex', '%s'); 
...
for i = 1:n
    ...
    % Gestione del segno per Q5.11 (se necessario, altrimenti resta unsigned)
    if val_hw >= 32768, val_hw = val_hw - 65536; end 
    hw_output(i) = val_hw / 2048;
end
